...
// Original file: https://github.com/javierhonduco/rbperf/blob/573ebc0a90f05ca0ef9b26ae7825d27468035cf1/xtask/src/main.rs

// For all releases, see: https://www.ruby-lang.org/en/downloads/releases
...
pub fn dump_ruby_structs_ruby_3_1_3() {
    let vm_offset: i32 = offset_of!(
        rbspy_ruby_structs::ruby_3_1_3::rb_execution_context_struct,
        vm_stack
    ) as i32;
    ...
    let control_frame_t_sizeof: i32 =
        size_of::<rbspy_ruby_structs::ruby_3_1_3::rb_control_frame_struct>() as i32;
    ...
    let label_offset: i32 = offset_of!(
        rbspy_ruby_structs::ruby_3_1_3::rb_iseq_location_struct,
        label
    ) as i32;

    let line_info_table_offset: i32 = offset_of!(
        rbspy_ruby_structs::ruby_3_1_3::rb_iseq_constant_body,
        insns_info
    ) as i32;

    let line_info_size_offset: i32 = line_info_table_offset
        + (offset_of!(
            rbspy_ruby_structs::ruby_3_1_3::rb_iseq_constant_body_iseq_insn_info,
            size
        ) as i32);

    let main_thread_offset: i32 = offset_of!(
        rbspy_ruby_structs::ruby_3_1_3::rb_vm_struct__bindgen_ty_1,
        main_thread
    ) as i32;

    let ruby_3_1_3_offsets = RubyVersionOffsets {
        major_version: 3,
        minor_version: 1,
        patch_version: 3,
        vm_offset,
...
pub fn dump_ruby_structs_ruby_3_2_0() {
    ...
    let ruby_3_2_0_offsets = RubyVersionOffsets {
        major_version: 3,
        minor_version: 2,
        patch_version: 0,
        vm_offset,
...
pub fn dump_ruby_structs_ruby_3_2_1() {
    let vm_offset: i32 = offset_of!(
        rbspy_ruby_structs::ruby_3_2_1::rb_execution_context_struct,
        vm_stack
    ) as i32;
    ...
    let control_frame_t_sizeof: i32 =
        size_of::<rbspy_ruby_structs::ruby_3_2_1::rb_control_frame_struct>() as i32;
    ...
    let label_offset: i32 = offset_of!(
        rbspy_ruby_structs::ruby_3_2_1::rb_iseq_location_struct,
        label
    ) as i32;

    let line_info_table_offset: i32 = offset_of!(
        rbspy_ruby_structs::ruby_3_2_1::rb_iseq_constant_body,
        insns_info
    ) as i32;

    let line_info_size_offset: i32 = line_info_table_offset
        + (offset_of!(
            rbspy_ruby_structs::ruby_3_2_1::rb_iseq_constant_body_iseq_insn_info,
            size
        ) as i32);

    let main_thread_offset: i32 = offset_of!(
        rbspy_ruby_structs::ruby_3_2_1::rb_vm_struct__bindgen_ty_1,
        main_thread
    ) as i32;

    let ruby_3_2_1_offsets = RubyVersionOffsets {
        major_version: 3,
        minor_version: 2,
        patch_version: 1,
        vm_offset,
